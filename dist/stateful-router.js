(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["stateful-router"] = factory();
	else
		root["stateful-router"] = factory();
})(window, function() {
...
var RouterContext = /*#__PURE__*/Object(react["createContext"])('');
...
var Router_Router = function Router(_ref) {
  var children = _ref.children,
      path = _ref.path;
  return /*#__PURE__*/react_default.a.createElement(src_RouterContext.Provider, {
    value: path
  }, children);
};
...
var Route_Route = function Route(_ref) {
  ...
  var path = Object(react["useContext"])(src_RouterContext);
  if (!isMatch(path, route)) return null;
  return react_default.a.Children.map(children, function (child) {
    return /*#__PURE__*/Object(react["isValidElement"])(child) ? /*#__PURE__*/Object(react["cloneElement"])(child, getParams(path, route)) : child;
  });
};

...
var Route_Route = function Route(_ref) {
  ...
  if (!isMatch(path, route)) return null;
  return external_react_default.a.Children.map(children, function (child) {
    return /*#__PURE__*/Object(external_react_["isValidElement"])(child) ? /*#__PURE__*/Object(external_react_["cloneElement"])(child, getParams(path, route)) : child;
  });
};

Route_Route.propTypes = {
  route: external_prop_types_default.a.string
};
